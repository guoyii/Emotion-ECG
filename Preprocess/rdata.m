...
%------ SPECIFY DATA ------------------------------------------------------
%------ 指定数据文件 -------------------------------------------------------
PATH= 'C:\Users\Admin\Desktop\ECG\mit-bih-arrhythmia-database-1.0.0'; % 指定数据的储存路径

HEADERFILE= '1 (25).hea';      % .hea 格式，头文件，可用记事本打开
ATRFILE= '1 (25).atr';         % .atr 格式，属性文件，数据格式为二进制数
DATAFILE='1 (25).dat';         % .dat 格式，ECG 数据
SAMPLES2READ=650000;          % 指定需要读入的样本数 %%all 650000 %sampling rate 360
                            % 若.dat文件中存储有两个通道的信号:
